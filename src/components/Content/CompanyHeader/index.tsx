  ...
  return (
    <div className="flex justify-between w-[100%]">
      ...
      <div className="flex gap-2">
        <button className="flex items-center gap-2 border border-[#D8DFE6] rounded-sm py-1 px-2 text-[#77818C]">
          <Image src={thunderboltIcon} alt="energy" className="w-4 h-4" />

          Sensor de energia
        </button>

        <button className="flex items-center gap-2 border border-[#D8DFE6] py-1 px-2 text-[#77818C]">
